...
const Dashboard: React.FC = () => {
  ...
  const recentActivity = [
    { action: "Created collection 'user_profiles'", user: "admin", time: "2 minutes ago" },
    { action: "Added 15 records to 'products'", user: "john.doe", time: "5 minutes ago" },
    { action: "Updated schema for 'orders'", user: "jane.smith", time: "10 minutes ago" },
    { action: "Created new user 'mike.wilson'", user: "admin", time: "15 minutes ago" },
  ]

  return (
    <div className="flex-1 space-y-4 md:space-y-6">
      <header className="flex h-14 md:h-16 shrink-0 items-center gap-2 border-b px-4 -mx-6 -mt-8 mb-6">
