...
mod tests {
    ...
    fn test_boolean_conversion() {
        ...
        assert_eq!(field_type.convert_value(&json!(false)).unwrap(), json!(false));
        ...
        assert_eq!(field_type.convert_value(&json!("yes")).unwrap(), json!(true));
        assert_eq!(field_type.convert_value(&json!("no")).unwrap(), json!(false));
