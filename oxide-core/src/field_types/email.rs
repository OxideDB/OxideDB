...
mod tests {
    ...
    fn test_email_validation() {
        ...
        // Valid emails
        assert!(field_type.validate("test", &json!("user@example.com")).is_ok());
        assert!(field_type.validate("test", &json!("test@domain.org")).is_ok());
        
        // Invalid emails
        assert!(field_type.validate("test", &json!("invalid-email")).is_err());
    ...
    fn test_email_conversion() {
        ...
        // Valid email
        assert_eq!(field_type.convert_value(&json!("test@example.com")).unwrap(), json!("test@example.com"));
