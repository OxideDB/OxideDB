...
impl VirtualFileSystem for VfsServiceWrapper {
    async fn create_namespace(
        &self,
        config: oxide_core::VfsNamespaceConfig,
    ...
    async fn get_usage_stats(
        &self,
        namespace: &oxide_core::VfsNamespace,
    ) -> oxide_core::VfsResult<oxide_core::VfsUsageStats> {
    ...
    async fn get_namespace_config(
        &self,
        namespace: &oxide_core::VfsNamespace,
    ) -> oxide_core::VfsResult<oxide_core::VfsNamespaceConfig> {
        self.inner.get_namespace_config(namespace).await
    }

    async fn update_namespace_config(
        &self,
        config: oxide_core::VfsNamespaceConfig,
    ) -> oxide_core::VfsResult<()> {
